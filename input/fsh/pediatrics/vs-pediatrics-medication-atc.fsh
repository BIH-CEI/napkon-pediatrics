...
* $atcde#L04AC03 "Anakinra" // Anakinra
* codes from system $atcde where concept is-a #J06B "IMMUNGLOBULINE" // Immunoglobuline
...
* $atcde#N01AX13 "Distickstoffmonoxid" // N2O
* $atcde#N01AX63 "Distickstoffmonoxid, Kombinationen"  // N2O
